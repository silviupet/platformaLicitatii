 ...
 */
final class Version20190822123832 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE product_description product_description VARCHAR(255) DEFAULT NULL, CHANGE photo_b photo_b VARCHAR(255) NOT NULL, CHANGE photo_c photo_c VARCHAR(255) DEFAULT NULL, CHANGE photo_d photo_d VARCHAR(255) DEFAULT NULL, CHANGE photo_e photo_e VARCHAR(255) DEFAULT NULL, CHANGE photo_f photo_f VARCHAR(255) DEFAULT NULL');
